...
[[gui]] GUI::
GUI is an acronym for Graphical User Interface. It is a graphical interface which facilitates interaction
between the user and the software using visual elements.
